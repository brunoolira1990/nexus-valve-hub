...
import { EditarAcessoPanel } from './EditarAcessoPanel';
import { RedefinirSenhaColaboradorPanel } from './RedefinirSenhaColaboradorPanel';
...
export function ColaboradorAcessoSection({ colaborador, onRefresh }: Props) {
  ...
  return (
    <>
      {modal === 'editar' ? (
        <EditarAcessoPanel colaborador={c} onClose={closeModal} onSuccess={handleSuccess} />
      ) : modal === 'senha' ? (
        <RedefinirSenhaColaboradorPanel colaborador={c} onClose={closeModal} onSuccess={handleSuccess} />
      ) : (
