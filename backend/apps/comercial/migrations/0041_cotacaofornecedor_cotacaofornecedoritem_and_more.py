# Generated by Django 5.2 on 2026-08-28 19:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('produtos', '0029_produtomanometroskusequencia'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-data', '-id'],
                'permissions': (('registrar_resposta_cotacaofornecedor', 'Pode registrar resposta de cotação com fornecedor'), ('selecionar_referencia_cotacaofornecedor', 'Pode selecionar referência de cotação com fornecedor'), ('cancel_cotacaofornecedor', 'Pode cancelar cotação com fornecedor')),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('cotacao', 'item_proposta'), name='uniq_cotacao_item_proposta'),
        ),
        migrations.AddConstraint(
            model_name='cotacaofornecedoritem',
            constraint=models.CheckConstraint(condition=models.Q(('quantidade__gte', Decimal('0'))), name='cot_item_quantidade_nao_neg'),
        ),
        migrations.AddConstraint(
            model_name='cotacaofornecedorparticipante',
            constraint=models.UniqueConstraint(fields=('cotacao', 'fornecedor'), name='uniq_cotacao_fornecedor_participante'),
        ),
        migrations.AddConstraint(
            model_name='cotacaofornecedorrespostaitem',
            constraint=models.UniqueConstraint(fields=('participante', 'cotacao_item'), name='uniq_cotacao_resposta_participante_item'),
        ),
        migrations.AddConstraint(
            model_name='cotacaofornecedorrespostaitem',
            constraint=models.CheckConstraint(condition=models.Q(('preco_unitario__isnull', True), ('preco_unitario__gte', Decimal('0')), _connector='OR'), name='cot_resp_preco_nao_neg'),
        ),
        migrations.AddConstraint(
            model_name='cotacaofornecedorrespostaitem',
            constraint=models.CheckConstraint(condition=models.Q(('quantidade_atendida__gte', Decimal('0'))), name='cot_resp_qtd_atendida_nao_neg'),
        ),
        migrations.AddConstraint(
            model_name='cotacaofornecedorrespostaitem',
            constraint=models.CheckConstraint(condition=models.Q(('frete__isnull', True), ('frete__gte', Decimal('0')), _connector='OR'), name='cot_resp_frete_nao_neg'),
        ),
    ]
