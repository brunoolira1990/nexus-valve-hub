...
STATUS_PROPOSTA_PARCIALMENTE_CONVERTIDA = 'PARCIALMENTE_CONVERTIDA'
STATUS_PROPOSTA_REABERTA = 'REABERTA'
...
_LABELS_STATUS_PROPOSTA = {
    ...
    'Rejeitada': 'Rejeitada',
    STATUS_PROPOSTA_CONVERTIDA: 'Convertida',
    STATUS_PROPOSTA_PARCIALMENTE_CONVERTIDA: 'Parcialmente convertida',
    STATUS_PROPOSTA_REABERTA: 'Reaberta',
    'PERDIDA': 'Perdida',
    'Perdida': 'Perdida',
    'Pendente': 'Pendente',
