"""Resposta JSON padronizada da emissão NF-e em produção SEFAZ."""
...
def montar_resposta_emissao_producao(
    nf: NFeSaida | None,
    *,
    ok: bool,
    ...
    if autorizado is None:
        autorizado = ok and bool(
            cstat in ('100', '150')
            or (nf and nf.status_emissao_sefaz == NFeSaida.StatusEmissaoSefaz.AUTORIZADA_PRODUCAO),
        )
    ...
    if nf:
        ...
        payload['ambiente_emissao'] = nf.ambiente_emissao or 'producao'
    if extras:
